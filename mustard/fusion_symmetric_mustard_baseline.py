"""
SYMMETRIC FUSION – BASELINE MODELS (MUStARD)
=============================================
Uses baseline (non-distilled) text models with symmetric fusion.
"""
...
# ══════════════════════════════════════════════════════════════════════════════
BASELINE_CONFIG = 'bert_videomae'   # ← CHANGE: 'bert_videomae', 'bert_pe_core',
...
print(f"\n{'='*70}")
print(f"SYMMETRIC BASELINE FUSION: {CONFIG['name']}")
print(f"{'='*70}")
...
OUTPUT_DIR        = f'predictions_output_fusion_symmetric_baseline_{BASELINE_CONFIG}'
...
for fold in range(5):
    ...
    text_baseline.load_state_dict(torch.load(
    ...
    model = SymmetricFusion(text_baseline, audio_baseline, video_baseline).to(device)
    ...
    ckpt_path = f"{CHECKPOINTS_DIR}/fusion_symmetric_baseline_{BASELINE_CONFIG}_fold_{fold}.pth"
